...
def register(request):
    if request.method == "POST":  # Corrected this line
        ...
        if form.is_valid():
            ...
            user.set_password(form.cleaned_data['password1'])  # Ensure you have password1 in your form
            user.save()
            login(request, user)  # Log the user in after registration
            return redirect('tweet_list')  # Redirect to the tweet list or another page
    else:
